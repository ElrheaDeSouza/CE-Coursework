...
public class BinaryChecksumReceiver {
    public static void main(String[] args) {
        ...
        // 4 Divide received data into segments
        ...
        // 6: Compute 1's complement of the sum
        ...
        // 8: Extract and display the transmitted data (without the checksum)
